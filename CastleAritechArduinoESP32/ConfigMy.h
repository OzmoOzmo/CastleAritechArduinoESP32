...
//Wifi Password
#define WIFI_SSID "Access_1" //"{WIFI NAME HERE}"
#define WIFI_PASSWORD "Saitek99!!" //"{WIFI PASS HERE}"

//The Arduino IP address and Port (eg. 192.168.1.67)
#define IP_ME "192.168.0.67"
...
#define SMTP_USER "ozusnet@gmail.com"   //SMTP account name to send from (www.gmx.com is a good option)
#define SMTP_PASS "mbx125"              //SMTP account password to send from
#define EMAIL_ADDR "ambrosec@gmail.com"  //Email to send to
...
//Todo: look at built in ESP32 Logging: https://thingpulse.com/esp32-logging/
